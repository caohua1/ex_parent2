package com.ex.controller.merchant_pc_controller.MerchantElectController;
 ...
 */
@RestController
@RequestMapping("/PCmutualReferring")
public class MerchantElectController {

    @Autowired
    private com.ex.service.MerchantRegistService MerchantRegistService;
