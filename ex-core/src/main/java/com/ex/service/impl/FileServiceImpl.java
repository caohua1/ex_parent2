...
import com.ex.service.IFileService;
import com.ex.util.EncodeUtils;
import com.ex.util.FileUtils;
...
public class FileServiceImpl implements IFileService {
    ...
    @Override
    public JsonView upload(InputStream inputStream, String type,
   ...
   /* @Override
     ...
     * @return
     */
    private JsonView getResult(String filePath, String realName, long fileSize) {
        ...
        result.setCode(JsonView.SUCCESS);
        result.setData(data);
