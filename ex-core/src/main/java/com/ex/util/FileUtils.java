...
public class FileUtils {
    ...
    /*从文件id中获取文件信息*/
	public static Map<String,Object> getInfoByFileId(String id){
		Map<String,Object> result = new HashMap<String,Object>();
		try {
			String filePath = new String(EncodeUtils.base64Decode(id),"UTF-8");
			String url = EncodeUtils.urlDecode(filePath);
			String path  = url.substring(0,url.lastIndexOf("_"));
			String name = url.substring(url.lastIndexOf("_")+1);
			result.put("url",path);
